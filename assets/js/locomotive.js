!(function (t, e) {
  ...
  class n {
    ...
    fromTo(t, e, { lerp: i, duration: s, easing: n, onStart: r, onUpdate: o }) {
  ...
  class a {
    constructor(t, { wheelMultiplier: e = 1, touchMultiplier: i = 1 }) {
      (this.lastDelta = { x: 0, y: 0 }),
        ...
        (this.onTouchMove = (t) => {
          var e, i, s, n;
          const { clientX: r, clientY: o } = t.targetTouches
              ? t.targetTouches[0]
              : t,
            l =
              -(
                ...
                (null !==
                  (i =
                    null === (e = this.touchStart) || void 0 === e
                      ? void 0
                      : e.x) && void 0 !== i
                  ? i
                  : 0)
          ...
          (this.touchStart.x = r),
            (this.touchStart.y = o),
            (this.lastDelta = { x: l, y: a }),
            this.emitter.emit("scroll", { deltaX: l, deltaY: a, event: t });
        }),
        (this.onTouchEnd = (t) => {
  ...
  class h {
    constructor({
      ...
      (this.__isScrolling = !1),
          ...
          if (
            o.find((t) => {
              ...
              return (
                ...
                (("function" == typeof l && (null == l ? void 0 : l(t))) ||
        ...
        (this.animate = new n()),
        (this.emitter = new o()),
        (this.dimensions = new r({ wrapper: t, content: e, autoResize: w })),
        ...
        (i._computeProgress = function (t) {
          ...
          if (((this.progress = s), s != this.lastProgress)) {
            if (
              ...
              for (
                var n, r = e(this.progressModularModules);
                !(n = r()).done;
        ...
        (i.onRender = function (t) {
          for (
            var i,
              s = t.currentScroll,
              n = t.smooth,
              r = e(this.scrollElementsToUpdate);
            !(i = r()).done;
    ...
    f = /*#__PURE__*/ (function () {
      ...
      return (
        (i._init = function () {
          ...
          for (var i, s = e(this.$resizeElements); !(i = s()).done; )
            this.observer.observe(i.value);
        }),
        (i.destroy = function () {
          this.observer.disconnect();
        }),
  ...
  return (function () {
    function t(t) {
      ...
      for (var p = 0, f = Object.entries(s); p < f.length; p++) {
        var g = f[p][0];
        ["wrapper", "content", "infinite"].includes(g) &&
          console.warn(
            'Warning: Key "' +
              g +
